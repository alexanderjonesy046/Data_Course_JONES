...
The red dots on the node points allow us to see the branch points on the tree much easier
...
ggtree(tree2, layout = "rectangular", branch.length = "none") +
  geom_tiplab(size = 3) +xlim(0,33) + geom_nodepoint(color = "red", ) +
  labs(title = "Poaceae Family Tree")
```
